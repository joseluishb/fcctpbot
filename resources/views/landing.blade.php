                ...
                <div>
                    <div class="">
                        ...
                        <div class="flex justify-left w-full mt-4">
                            <a href="https://app.powerbi.com/view?r=eyJrIjoiZTgyNjRiNjAtZjU0Ny00N2MzLTk3N2ItYmY0NDEyNzE1YjQ1IiwidCI6Ijk4MjAxZmVmLWQ5ZjYtNGU2OC04NGY1LWMyNzA1MDc0ZTM0MiIsImMiOjR9"
                                target="_blank"
                    ...
                    <div class="mt-10 gap-4 content-center">
                        ...
                        <div class="flex flex-col lg:flex-row md:flex-row sm:flex-col m-1 gap-4  grid-cols-12 ">
                            <div class="col-span-6 border p-4 rounded-md shadow-md md:w-1/2 sm:w-full">
                                ...
                                <a href="https://matricula.fcctp.edu.pe/documentos/20252/plan-ps-Ingresantes-hasta-el-semestre-2022-I.pdf" target="_blank">
                                    <div
                            ...
                            <div class="border p-4 rounded-md shadow-md md:w-1/2 sm:w-full">
                                ...
                                <a href="https://matricula.fcctp.edu.pe/documentos/20252/plan-ps-Ingresantes-a-partir-del-2022- II.pdf" target="_blank">
                                    <div
                                        class="text-sm border my-2 py-4 px-5 border-gray-300 rounded w-100 text-left bg-white border-l-4 border-l-blue-500 hover:bg-blue-500 hover:text-white transition-all duration-300 ease-out">
                                        <div class="flex content-center align-center justify-between">
                                            <div>Psicología</div>
            ...
            <div class="p-6 flex-1 content-center">
                ...
                <div class="">
                    ...
                    <div class="bg-white shadow-md rounded-lg p-6 w-full border border-gray-100 mb-5">
                        ...
                        <div class="pt-4">
                            <a href="{{ URL('/documentos/cc-talleres-formulas-2025_3.pdf') }}" target="_blank"
